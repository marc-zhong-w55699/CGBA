...
# ============================================================================
# ImageNet variant: state machine (EXPLOIT/EXPLORE/REFINE) + DCT low-freq.
# Pure attack class.
#
# Differences vs M2D_explore_dct_imagenet.py:
#     λ : 固定 (0.2,0.2,0.6) → 动态 state machine
#         EXPLOIT: (0.4, 0.3, 0.3)
#         EXPLORE: (0.2, 0.2, 0.6)
#         REFINE : (0.3, 0.5, 0.2)
#     Thresholds: EPS_PROGRESS=0.005, STAG_THRESH=5,
#                 R_REFINE_RATIO=0.15, MIN_DWELL=2 (UNCHANGED)
# ============================================================================
