...
# ============================================================================
# CIFAR-10 state machine (EXPLOIT/EXPLORE/REFINE) + SurFree-style DCT direction.
# Pure attack class. Same DCT-SF infrastructure as M2D_explore_dctsf_cifar10.py.
# β = π/12, freq_range = (0, 0.5), tanh_gamma = 1.0
# State weights / thresholds same as pro_atk_tuned.py (UNCHANGED).
# ============================================================================
