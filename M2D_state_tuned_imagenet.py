...
# ============================================================================
# ImageNet variant of pro_atk_tuned.py (state machine: EXPLOIT/EXPLORE/REFINE)
# Pure attack class — NO top-level execution code.
#
# Differences vs M2D_explore_tuned_imagenet.py:
#     λ : 0.2, 0.2, 0.6 (固定 explore) → 由 state machine 动态切换:
#         EXPLOIT: (0.4, 0.3, 0.3)
#         EXPLORE: (0.2, 0.2, 0.6)
#         REFINE : (0.3, 0.5, 0.2)
#     State transitions driven by progress (delta_rel) and stagnation (stag_k).
#     State machine thresholds: EPS_PROGRESS=0.005, STAG_THRESH=5,
#                               R_REFINE_RATIO=0.15, MIN_DWELL=2
# ============================================================================
...
class Proposed_attack():
    ...
    def Attack(self):
        ...
        # ── State machine constants (UNCHANGED from pro_atk_tuned.py) ──
