# Fair_cgba_cifar10.py
'''
Fair-comparison driver for CIFAR-10 CGBA (non-targeted).
Structure identical to Fair_attack_cifar10.py; only 3 differences:
  - imports CGBA `Proposed_attack` (from proposed_attack, which we patched
    with inline post-verify)
  - attack_methods = ['CGBA']
