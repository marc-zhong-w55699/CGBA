# Surfree_attack_cifar10.py
# 用 SurFree 攻击 CIFAR-10 模型（preactresnet18 / wideresnet40_2）。
# 结构与 Non_targeted_attack_cifar10.py 对齐，输出 npz 字段相同
...
for model_name in MODEL_NAMES:
    ...
    for attack_method in attack_methods:
        ...
        if len(all_norms) > 0:
            ...
            save_dir = 'Surfree_results_cifar10'
