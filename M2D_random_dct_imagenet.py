...
# ============================================================================
# ImageNet variant: random (λ=0,0,1) + DCT low-frequency sampling.
# Pure attack class.
#
# Differences vs M2D_explore_dct_imagenet.py:
#     λ : 0.2, 0.2, 0.6 → 0, 0, 1 (pure DCT noise — no momentum, no progress)
# ============================================================================
...
class Proposed_attack():
    ...
    def Attack(self):
        ...
        inner_n = 15
        lam1, lam2, lam3 = 0, 0, 1            # ★ random (pure DCT noise)
