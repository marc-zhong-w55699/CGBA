...
# ============================================================================
# Tuned variant of pro_atk.py (state machine: EXPLOIT/EXPLORE/REFINE)
# ★ Changes vs pro_atk.py:
...
#     state machine thresholds: ALL UNCHANGED (EPS_PROGRESS, STAG_THRESH,
#                               R_REFINE_RATIO, MIN_DWELL)
# ============================================================================
...
class Proposed_attack():
    ...
    def Attack(self):
        ...
        # State machine (UNCHANGED from pro_atk.py)
