...
# ============================================================================
# CIFAR-10 M2D-explore (λ=0.2,0.2,0.6) + v3 geometry + v5 adaptive theta_max.
# Pure attack class. No DCT.
#
# vs M2D_random_v5_cifar10.py:
#     λ : 0, 0, 1 (random) → 0.2, 0.2, 0.6 (explore)
#     保留 d1 progress + d2 momentum，让 u 不只依赖 random noise
#
# v5 = explore_v3 + adaptive theta_max (replaces the fixed π/3 = 60°).
#
# Motivation:
